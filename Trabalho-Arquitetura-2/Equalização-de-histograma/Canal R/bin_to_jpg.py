...
def main():
    for i in range(3):
        if i == 0:
            bin_to_jpg("bins/Imagem_R.bin", "imagens/Imagem_R.jpg")
        elif i == 1:
            bin_to_jpg("bins/Imagem_R_eq_python.bin",
                       "imagens/Imagem_R_equalizada_altonivel.jpg")
        elif i == 2:
            bin_to_jpg("bins/Imagem_R_eq_assembly.bin",
                       "imagens/Imagem_R_equalizada_baixonivel.jpg")
